...
WIN_WIDTH = WINDOWWIDTH    # BG image size: 284x512 px; tiled twice
...
def load_images():
    ...
    def load_image(img_file_name):
        ...
        img = pygame.image.load('images/' + img_file_name)
        img.convert()
        return img

    return {'background': load_image('spaacebg.jpg'),
...
def flappy_driver(user_name) :

    score = main(user_name)

    status = post_game_processing(user_name, score, "flappy")
    ...
    # play again
        ...
        return flappy_driver(user_name)